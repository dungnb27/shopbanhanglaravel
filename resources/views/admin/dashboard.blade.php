...
<div style="background: white">
    <div class="container-fluid">
        ...
        <div class="row">
            <br><h1 class="title_thongke">Thống kê đơn hàng doanh số</h1><br>
        ...
        <div class="row">
            ...
            <hr><br><h1 class="title_thongke">Thống kê truy cập</h1><br>
                    ...
                    @foreach ($post_views as $key => $post)
                        <li>
                            <a target="_blank" href="{{ url('/bai-viet/' . $post->post_slug) }}">{{ $post->post_title }} |
                                <span style="color:black">{{ $post->post_views }}</span></a>
                        </li>
                    @endforeach
                </ol>
            ...
            <div class="col-md-4 col-xs-12">
                ...
                <ol class="list_views">
                    @foreach ($product_views as $key => $pro)
                        <li>
                            <a target="_blank"
                                href="{{ url('/chi-tiet-san-pham/' . $pro->product_id) }}">{{ $pro->product_name }} |
