    ...
    <div class="panel panel-default">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped b-t b-light" id="myTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><img src="public/uploads/product/{{$pro -> product_image}}" alt="{{$pro -> product_name}}" height="100" width="100" ></td>
              ...
              <td>
                ...
                <a onclick="return confirm('Bạn chắc chắn muốn xoá sản phẩm này ?')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
        ...
        <form action="{{url('import-csv-product')}}" method="POST" enctype="multipart/form-data">
          ...
          <input type="submit" value="Import file Excel" name="import_csv-product" class="btn btn-warning">
        </form>

        <!-----export data---->
          <form action="{{url('export-csv-product')}}" method="POST">
            @csrf
          <input type="submit" value="Export file Excel" name="export_csv-product" class="btn btn-success">
        </form>
      </div>
