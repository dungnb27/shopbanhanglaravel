          ...
          <tbody id="category_order">
            ...
            <tr  id="{{$cate_pro->category_id}}">
              ...
              <td>
                ...
                <a onclick="return confirm('Bạn chắc chắn muốn xoá danh mục này ?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
