    ...
    <div class="container" style="background: #222;border-radius: 12px;padding:15px;">
        <div class="col-md-12">
            ...
            <div class="row" style="background: cadetblue;padding: 15px">
                ...
                <div class="col-md-12">
                    <p style="color:#fff;font-size: 17px;">Bạn hoặc một ai đó đã đăng ký dịch vụ tại shop với thông tin
                        như sau:</p>
                    ...
                    <p>Phí ship hàng : <strong
                            style="text-transform: uppercase;color:#fff">{{ $shipping_array['fee'] }}</strong></p>
                    ...
                    <p style="color:#fff">Nếu thông tin người nhận hàng không có chúng tôi sẽ liên hệ với người đặt hàng
                        để trao đổi thông tin về đơn hàng đã đặt.</p>
                    ...
                    <table class="table table-striped" style="border:1px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="4" align="right">Tổng tiền thanh toán khi chưa áp dụng mã giảm giá:
                ...
                <p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank"
                        href="http://tiendung.com/shopbanhanglaravel">Tiến Dũng</a>, hoặc liên hệ qua số hotline : 19005689.Xin cảm ơn
                    quý khách đã đặt hàng shop chúng tôi.</p>
