                ...
                <ul class="nav nav-tabs">
                    ...
                    @foreach ($cate_pro_tabs as $key => $cat_tab)
                        @php
                            $i++;
                        @endphp
                        <li class="tabs_pro {{ $i == 1 ? 'active' : '' }} " data-id="{{ $cat_tab->category_id }}"><a
                                href="" data-toggle="tab">{{ $cat_tab->category_name }}</a></li>
                    ...
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <form>
                                ...
                                <button type="button" data-toggle="modal" data-target="#xemnhanh"
                                    class="btn btn-default xemnhanh" name="add-to-cart"
                                    data-id_product="{{ $product->product_id }}">Xem nhanh</button>
