    ...
    <div class="coupon">
        ...
        <div class="container">
            <h3>Mã khuyến mãi dành cho khách thường từ shop <a target="_blank"
                    href="http://tiendung.com/shopbanhanglaravel/">http://tiendung.com/shopbanhanglaravel/</a>
            </h3>
        </div>
        <div class="container" style="background-color:white">
            ...
            <h2 class="note"><b><i>
				...
				@endif --}}
                        Giảm 20% cho tổng đơn hàng đặt mua</i></b></h2>

            <p>Quý khách đã từng mua hàng tại shop <a target="_blank" style="color:red"
                    href="http://tiendung.com/shopbanhanglaravel/">tiendung.com</a> nếu đã có tài khoản xin vui lòng <a
                    target="_blank" style="color:red"
                    href="http://tiendung.com/shopbanhanglaravel/">đăng nhập</a> vào
