...
{   
    ...
    public function callback_facebook_customer(){
        ...
        if($account!=NULL){
           ...
           return redirect('/checkout')->with('message', 'Đăng nhập bằng tài khoản facebook <span style="color:red">'.$account_name->customer_email.'</span> thành công');  
        ...
        return redirect('/checkout')->with('message', 'Đăng nhập bằng tài khoản facebook <span style="color:red">'.$account_new->customer_email.'</span> thành công');      
