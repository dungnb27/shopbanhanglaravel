...
class CheckoutController extends Controller
{
    ...
    public function login_checkout(Request $request){
        ...
        $meta_keywords = "Dang nhap thanh toan";
    ...
    public function add_customer(Request $request){
        ...
        return Redirect::to('/checkout')->with('message', 'Đăng kí thành công !');;
    }
    ...
    // {
    //     //SEO
    //     $meta_desc = "Thanh toán khi nhận hàng";
    //     $meta_keywords = "Thanh toán khi nhận hàng";
    //     $meta_title = "Thanh toán khi nhận hàng";
    //     $url_canonical = $request->url();
    //     //SEO
    ...
    {
        Session::flush();
        return Redirect::to('/login-checkout')->with('error', 'Đăng xuất thành công');;
    }
    ...
    public function login_customer(Request $request)
    {
        ...
        if($result){
            ...
            return Redirect::to('/login-checkout')->with('error', 'Tên đăng nhập hoặc mật khẩu không chính xác!');
        }
