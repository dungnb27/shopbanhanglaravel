...
class DocumentController extends Controller
{
    ...
    public function upload_file(){
        ...
        $filePath = public_path('uploads\avatar.png');
    ...
    {
        Storage::cloud()->put('test.txt', 'Dũng');
        dd('created');
    }

    public function upload_image(){
        $filename = '11-pro-max-den.png';
        $filePath = public_path('uploads\product\11-pro-max-den13.png');
        $fileData = File::get($filePath);
        Storage::cloud()->put($filename, $fileData);
