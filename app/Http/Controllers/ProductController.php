...
class ProductController extends Controller
{
    ...
    public function save_product(Request $request){
        ...
        $num_cost = filter_var($request->price_cost, FILTER_SANITIZE_NUMBER_INT);
    ...
    public function export_csv_product(){
        return Excel::download(new ExportProduct , 'all_product.xlsx');
    }
    ...
    public function load_comment(Request $request)
    {
        ...
        foreach($comment as $key => $comm){
            ...
            <div class="row style_comment">
                                        ...
                                        <div class="col-md-2">
                                            <img width="100%" src="'.url('/public/uploads/avatar.png').'" class="img img-responsive img-thumbnail">
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    foreach($comment_rep as $key => $rep_comment)  {
                                     ...
                                     $output.= ' <div class="row style_comment" style="margin:5px 40px;background: aquamarine;">
                                        ...
                                        <div class="col-md-2">
                                            <img width="80%" src="'.url('/public/uploads/avatarAdmin.png').'" class="img img-responsive img-thumbnail">
                                        </div>
                                        <div class="col-md-10">
                                            <p style="color:blue;">@Dũng</p>
    ...
    public function reply_comment(Request $request)
    {
        ...
        $comment->comment_name = 'DũngStore';
        $comment->save();
